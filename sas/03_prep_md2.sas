...
%let g_path      = C:\PeCAN_work\data;   /* OUTSIDE the repo tree -- RESEARCH Pitfall 9 */
...
data g.prep_md2;
  length
    ...
    /* INSERT all remaining character variables for MASTER_DATA_2 here,
       with widths from qc/03_charvars_all.txt (MASTER_DATA_2 rows).
       Example format:
         Variable_Name   $<width>
